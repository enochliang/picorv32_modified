...
pysim_ff:
	...
	cp rtl/testbench_pysim_wrapper.v ./testbench.v
	rm pysim_ff_value -rf
	mkdir pysim_ff_value
	make test

fsim_ff:
	cp rtl/picorv32_modified.v ./picorv32.v
	cp rtl/testbench_ff_wrapper.v ./testbench.v
	rm ff_value -rf
	rm golden_value -rf
	mkdir ff_value
	mkdir golden_value
...
test_verilator_binary: testbench_verilator firmware/firmware.hex
	./testbench_verilator
...
testbench_verilatori_binary: testbench.v picorv32.v
	$(VERILATOR) --binary --exe -Wno-lint -trace --top-module picorv32_wrapper testbench.v picorv32.v \
			$(subst C,-DCOMPRESSED_ISA,$(COMPRESSED_ISA)) --Mdir testbench_verilator_dir
	$(MAKE) -C testbench_verilator_dir -f Vpicorv32_wrapper.mk
	cp testbench_verilator_dir/Vpicorv32_wrapper testbench_verilator
